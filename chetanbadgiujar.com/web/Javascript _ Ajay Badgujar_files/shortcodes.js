        ...
        $.AviaMapsAPI.prototype =
                {
                    ...
                    _applyMapStyle: function ()
                    {
                        ...
                        if (this.$data.hue != "")
                            stylers.push({hue: this.$data.hue});
                        if (this.$data.saturation != "")
                            stylers.push({saturation: this.$data.saturation});
                                ...
                                setTimeout(function ()
                                {
                                    ...
                                    if (_self.$data.marker[key].icon && _self.$data.marker[key].imagesize)
                                    {
                                        ...
                                        if (_self.retina && size > 40)
                                            size = 40;			//retina downsize to at least half the px size
        ...
        $.AviaVideoAPI.prototype =
                {
                    ...
                    api: function (action)
                    {
                        ...
                        if (this.isMobile && !this.was_started())
                            return;

                        // prevent calling of unbound function
                        if (this.options.events.indexOf(action) === -1)
                            return;
                ...
                methods =
                        {
                            ...
                            ajax_get_contents: function (post_id, clickedIndex)
                            {
                                ...
                                $.avia_utilities.preload({container: content_retrieved[post_id], single_callback: function () {
                                        methods.show_item(post_id, clickedIndex);
                                    }});
                            },
    ...
    $.fn.avia_sc_tabs = function (options)
    {
        ...
        return this.each(function ()
        {
            ...
            tabs.prependTo(tab_titles).each(function (i)
            {
                ...
                if (newtabs)
                    the_oldtab = oldtabs.filter(':eq(' + i + ')');
            ...
            return this.each(function ()
            {
                ...
                if ($.avia_utilities.isMobile)
                {
                    send.formElements.each(function (i)
                    {
                        ...
                        if (is_email)
                            currentElement.attr('type', 'email');
                    });
                }
    ...
    $.AviaccordionSlider.prototype =
            {
                _init: function (options)
                {
                    ...
                    $.avia_utilities.preload({container: this.$slider, single_callback: function () {
                            _self._kickOff();
                        }});
                },
                _kickOff: function ()
